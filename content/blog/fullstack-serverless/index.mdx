...
The development landscape is ever changing. In recent years there have been huge shifts in both back-end and front-end development. So, why am I bringing this up? Because I feel like all of this change is culminating in a new way of building apps. One that takes advantage of the changes we've seen over the last few years, both on the front-end and the back-end.

### Back-end and Serverless Computing
...
However, with this complexity came some really amazing tooling and frameworks. This explosion of tools and frameworks are essentially abstractions for dealing with the new complexity.

We are finally starting to see the opinionated software that is making it possible to deliver value as fast as possible. The best part is, we don't have to do it at the expense of things like accessibility and security. We get this baked right into the solutions.
...
Currently a lot of apps are built upon these new abstractions, it's not uncommon to see a React or Vue app using Auth0 or AWS Cognito to handle user management and authentication/authorization. Contentful is oftend used for content management, and coupled with Gatsby for the app. Yet they still don't feel like a cohesive solution. It feels like multiple things glued together.

What we're seeing now is platforms that encompass the best of both worlds. Providing a solutions for the entire development life cyle of an application. Making it much easier to build fully fledged applications that can scale without question and less cost than building out your own serverless infrastructure and tooling. Solutions like [Firebase](), [Netlify](), [Zeit](), and [AWS Amplify]() provide full-stack features such as toolkits and APIs, data storage, file storage, and build and deployment services. I refer to these types of platforms as `Full-stack Serverless` solutions. They provide feature sets that generally span from the CLI to back-end services and everything in between.

I recently ran a [poll on Twitter](https://twitter.com/kurtiskemple/status/1109126793938767872) where I posed the question, "When architecting a new application, what do you consider to be the most crucial concern when choosing solutions?"
...
I think previously there was always a concern with scale which made buying into these full-stack solutions difficult, but with the movement of serverless and compute power being a commodity now, I see this idea as a lot more approachable. I think we're in the very early stages of this new era of fullstack serverless platforms and I'm pretty excited to see where things go.
