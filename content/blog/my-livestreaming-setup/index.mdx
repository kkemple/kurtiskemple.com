...
> I use a [Macbook Pro](/what-i-use) and a lot of the recommendations here will be Mac focused by should be transferable to Windows as well.
...
I personally decided to go with SLOBS for the convenience it provides. It is currenly in beta on Mac which is something to consider.

> Unless otherwise mentioned, everything I talk about applies to both **SLOBS** and **OBS**.
...
The first step is to set the base resolution and output resolution of your video to `1920x1080` in (SL)OBS. You can do that by going to `Settings > Video` and changing the options.
...
- **Bacground Scenes**: Other folks, myself included, like to create a nice background scene with decorations and/or lighting. I have some of my favorite collectibles, books, and camera lenses behind me with some fun [light cubes](https://www.amazon.com/gp/product/B01E7684I2/) to add background lighting.

![my full background setup](./setup.jpg)

### Audio

#### The Cone of Silence

Much like with lighting, it's important to control the acoustics in your environment as much as possible. I use an acoustic divider to block noise coming from inside my house and because my desk is next to a window I use a sound absorbtion blanket to 1) block out light, 2) block out outside noise. Links to both can be found in my [what I use](/what-i-use) post.

#### Mic

This is the one area where I recommend getting the best possible piece of equipment you can. I don't know why, but it's easy to forgive not great video on a stream, but it's really hard to follow a stream with bad audio quality. Lot's of distracting background noise or too much reverb are sure-fire ways to lose viewers. I personally use a Shure microphone with some accessories. Check out my [what I use](/what-i-use) post for more info on my mic setup.
...
Loopback, which was mentioned in the capturing desktop audio section, makes it possible to create an audio input with your mic, and music source, and apps that your guests may want to also hear.
