...
description: "Learn how user frustration drives B2B SaaS disruption through Jobs to be Done, Frustration Coalition Risk, and Blue Ocean Strategy—and why AI makes every incumbent vulnerable."
...
Frustration Coalition Risk describes how individual user dissatisfaction organizes into collective action that drives competitive displacement. This framework introduces the [**Sentiment-Inertia Index**](./sentiment-inertia-index.mdx) `(Sii = (100-NPS)/Churn Rate)`, which measures trapped user frustration by quantifying the gap between declining satisfaction and stable retention due to switching costs.
