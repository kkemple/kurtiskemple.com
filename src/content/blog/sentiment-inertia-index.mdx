...
The Sentiment-Inertia Index is a predictive tool designed to identify and quantify the risk of a [frustration coalition](/blog/frustration-coalitions) forming within a user base. It measures the dangerous gap between [poor customer sentiment and low churn](/blog/the-captive-user-trap), which often indicates a large base of dissatisfied, trapped customers who are vulnerable to competitive displacement. A higher Sii score signifies a greater risk.
...
Looking at enterprise software companies shows how Sii scores translate to competitive risk in practice:
