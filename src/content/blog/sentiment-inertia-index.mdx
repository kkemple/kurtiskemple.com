...
The Sentiment-Inertia Index is a predictive tool designed to identify and quantify the risk of a [frustration coalition](./frustration-coalitions-the-hidden-threat-to-b2b-saas.mdx) forming within a user base. It measures the dangerous gap between [poor customer sentiment and low churn](./the-captive-user-trap.mdx), which often indicates a large base of dissatisfied, trapped customers who are vulnerable to competitive displacement. A higher Sii score signifies a greater risk.
