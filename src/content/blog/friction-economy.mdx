...
The Friction Economy framework exists within a broader set of established strategic principles, notably **Jobs to be Done (JTBD)** and **Blue Ocean Strategy**. Together, these frameworks provide an integrated view of market disruption driven by user frustration, collective action, and competitive repositioning.
...
### Blue Ocean Strategy: Competitive Exploitation of Frustration
...
Glean illustrates how failing to address evolving user expectations, particularly around search friction, creates opportunities for targeted disruption:

- Users increasingly frustrated with Slack's lexical, keyword-based search and complex syntax
- Glean leveraged AI-driven, semantic search to deliver more relevant and contextual results
- Immediate ecosystem integration and frictionless bottom-up adoption accelerated internal advocacy
- Shadow IT facilitated rapid coalition formation through demonstrable immediate value

Slack’s vulnerability underscores the imperative to proactively realign product capabilities with shifting core user expectations—especially as emerging technologies redefine competitive standards—to prevent coalition-driven displacement.
...
2. **Category collapse**: Traditional software categories will blur as PLG adoption by 91% of growth companies enables rapid feature expansion and AI redefines the job-to-be-done and how fast entrants can challenge incumbents.
...
The Friction Economy represents a fundamental shift in B2B SaaS competition. The 75% of companies showing no NPS-retention correlation built businesses on trapped users rather than satisfied customers. As PLG and AI eliminate traditional barriers, these companies face systematic disruption from competitors who understand that **reducing friction creates more value than adding features**.

The real irony is that Gartner predicts 75% of companies with stop measuring NPS by 2027. The

**Companies must choose**: eliminate friction proactively or watch competitors weaponize user frustration into market share. The Sentiment-Inertia Index provides an early warning system, but only organizations willing to fundamentally reimagine their user experience will survive the transition from the Lock-in Economy to the Friction Economy.
