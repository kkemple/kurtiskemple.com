...
image: "/images/og/content-creation.png"
pubDate: "11/24/2021"
homepage:
...
Many developer advocates experience these issues, myself included. Content creation is an essential skill set unto itself, and it's easy to get caught up in feeling like you're stuck or ending up with content that isn't of the quality you would like.
...
![The illustration shows five steps to the left. Three of the steps (Objective, Motivation, and Persona) are grouped under "Content Scoping" and the other two options (Hook and Questions) are grouped under "Content Discovery."](/images/blog/content-prework-light.png)
