...
The same shape applies wherever outputs must adhere to acceptance criteria: UI schemas, configuration manifests, API payloads, workflow definitions, code. This pattern is not specific to any single output type.
