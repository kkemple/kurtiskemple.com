...
This reflects the broader principle explored in [Information Physics](/blog/information-physics): all information systems naturally tend toward entropy without active energy input. Human cognitive systems follow the same optimization patterns as other information processing systems, making them subject to measurable entropy dynamics.
