...
In the program-based world of Developer Relations (DevRel), there's a phenomenon I like to call YAP - "Yet Another Program." It's a challenge that many DevRel teams face as they grow and expand their initiatives. But what exactly is YAP, and how can we counter it? Let's dive in.
...
> Check out the [full model](/blog/explaining-the-yap-model).
...
Leveraging tools like Slack Automation has been extremely valuable. We've automated routine tasks, notifications, and even some content distribution, saving countless hours of manual work.
