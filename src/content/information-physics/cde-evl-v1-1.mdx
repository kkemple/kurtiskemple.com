...
> Model available on GitHub as [CDE-EVL v1.1](https://github.com/kkemple/kurtiskemple.com/blob/main/core-ip-docs/models/cde_evl_v1_1.py)
>
> Documentation available as [CDE-EVL v1.1 Markdown](https://github.com/kkemple/kurtiskemple.com/blob/main/core-ip-docs/models/cde-evl-v1.1.md)
