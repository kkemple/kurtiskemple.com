...
title: "Information Physics: Notation & Symbols"
description: "Complete mathematical notation reference for the unified Information Physics framework. From fundamental constants (c, ℓₚ, tₚ) to framework-specific operators (SEC, COB, EG), this comprehensive glossary ensures mathematical consistency across Collision Theory, Electromagnetic Voxel Lattice, conscious navigation mathematics, and entropic mechanics—with LaTeX-ready formatting and validated numerical values."
