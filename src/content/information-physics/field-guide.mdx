...
During the creation of FCs, I discovered [Coalition Theory](https://en.wikipedia.org/wiki/The_Theory_of_Political_Coalitions) and saw striking resemblance to the six-stage framework I'd been developing for FCs. This led to [Network theory](https://en.wikipedia.org/wiki/Network_theory), [Complexity theory](https://en.wikipedia.org/wiki/Complexity_theory), [Percolation theory](https://en.wikipedia.org/wiki/Percolation_theory), and finally [Information theory](https://en.wikipedia.org/wiki/Information_theory)—each new field confirming patterns I'd observed independently.
...
The meaning of being human is that we don’t just endure the chaos of the universe—we choose how to move through it. To build or destroy, bring order or disorder—but whatever we decide, we do it in our own way. And that’s a beautiful thing. - *Kurtis Kemple*
