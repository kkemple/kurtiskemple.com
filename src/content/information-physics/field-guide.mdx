...
> [**Information Physics**](./theory): Humans evolved as entropy-competent beings who consistently organize systems to optimize information flow and resist decay.
...
> [**Conservation of Boundaries**](./conservation-of-boundaries): All system transformation follows `SEC = O × V / (1 + E)`, where entropy from observer position fundamentally changes outcomes.
...
> [**Entropic Mathematics**](./entropic-mathematics): A new mathematical framework for conscious systems where observer position determines possibility.
...
> [**Entropic Gap**](./entropic-gap): The measurable drift between intended and current states, calculated through vector mathematics as `EG = 1 - S(anchor, current)`.
...
> [**Entropic Equilibrium**](./entropic-equilibrium): Stability emerges when all actors have optimized from their observer-dependent positions, making further change impossible without coordination.
