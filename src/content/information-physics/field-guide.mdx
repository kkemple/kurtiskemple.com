...
Now, before we get started, I want to make it clear that this is a work in progress. I'm still discovering the patterns and the implications of the theory. Aside from all of this I'm also simultaneously living in three different realities: right now I could be the world's most high functioning delusional, I could be a pattern matching machine that landed on a sentence so generally applicable that it would make the design team at Home Goods envious, or I could have inadvertently discovered a new way to describe our place in the universe. *I'll let you formulate your own conclusions, all I ask is that you keep an open mind.*
...
The realization of COB's symmetry—that the same operations that build also destroy—made me physically ill. The first version of what would become the [Entropic Mathematics](/information-physics/entropic-mathematics) equation was born, *but without Information Physics or proper mathematical grounding, I tabled it as potential overreach in pattern matching.*
