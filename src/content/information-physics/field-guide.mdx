...
After discovering that **IP** and **COB** were the *WHY* and *HOW* behind [Nash Equilibrium's WHAT](https://en.wikipedia.org/wiki/Nash_equilibrium), the mathematical connection became undeniable.
