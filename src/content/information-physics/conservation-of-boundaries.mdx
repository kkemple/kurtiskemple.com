...
description: "How systemically bounded agents transform patterns through three fundamental operations: MOVE, JOIN, SEPARATE. Explore why these operations may represent the complete set of transformations available within entropic constraints."
