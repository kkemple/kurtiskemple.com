...
> **Conservation of Boundaries (COB):** The law that all system entropy change occurs through three irreducible operations—MOVE, JOIN, and SEPARATE—applied to existing boundaries within a system.
...
- **O** = Operations count (number of MOVE, JOIN, or SEPARATE actions)
- **V** = Vector (intent direction: positive reduces entropy, negative increases it)
- **E** = Entropy from observer position (resistance experienced)
...
Conservation of Boundaries reveals several profound truths about how system entropy changes. These insights transform how we approach change at every scale.
...
> - [**Information Physics Theory LLM Friendly Study Guide**](/information-physics-study-guide.txt): The theory behind Information Physics.
