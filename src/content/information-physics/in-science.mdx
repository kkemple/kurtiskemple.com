...
| Entropy cost per bit, sometimes irreversible operations $O_J^{(2)}$ or $O_S^{(3)}$                    | [Broken Symmetry, Frozen Accidents](https://www.preposterousuniverse) |
